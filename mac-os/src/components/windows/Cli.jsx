...
const Cli = ({ windowName, setWindowsState }) => {
    const commands = {
        about: {
            ...
            usage: 'about',
            fn: () => 'Final year engineering student, motivated Cloud & DevOps enthusiast with hands-on experience in Microsoft Azure, Docker, Linux.'
        },
        skills: {
            description: 'List technical skills',
            usage: 'skills',
            fn: () => `Frontend: React, Sass, HTML/CSS
...
Full Stack Developer @ Web Solutions (2020 - 2022)
  ...
  - Designed responsive UIs with React`
        ...
        contact: {
            ...
            usage: 'contact',
            fn: () => `Email: kunal018patil@gmail.com
Phone: 9322695095
Location: Pune, India`
        },
        github: {
        ...
        social: {
            ...
            usage: 'social',
            fn: () => `Twitter: @kunaldev
LinkedIn: /in/kunalgpatil
Portfolio: kunal-g-patil.dev`
        },
        echo: {
